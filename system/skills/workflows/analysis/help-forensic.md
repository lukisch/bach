...
**Version:** 1.0.0
**Erstellt:** 2026-01-24
**Service:** skills/_services/skills/docs/docs/docs/docs/help/
...
Prinzip: `skills/docs/docs/docs/docs/help/*.txt ist die WAHRHEIT` - aber nur wenn sie aktuell ist!
...
ls skills/docs/docs/docs/docs/help/*.txt

# Nach Aenderungsdatum sortiert (aelteste zuerst)
ls -lt skills/docs/docs/docs/docs/help/*.txt | tail -10

# Zufaellig waehlen
ls skills/docs/docs/docs/docs/help/*.txt | shuf | head -1
```
...
```
Ausgewaehlte Datei: skills/docs/docs/docs/docs/help/[name].txt
...
```bash
cat skills/docs/docs/docs/docs/help/[name].txt
```
...
1. In ROADMAP.md eintragen:
   | HELP_[NNN] | [Feature] implementieren (aus skills/docs/docs/docs/docs/help/[name].txt) | OFFEN |
...
**Datum:** YYYY-MM-DD
**Datei:** skills/docs/docs/docs/docs/help/[name].txt
...
- `skills/_services/skills/docs/docs/docs/docs/help/SKILL.md` - Service-Beschreibung
