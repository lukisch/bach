...
|--------|---------|--------|
| skills/docs/docs/docs/docs/help/*.txt | Alle Handler dokumentiert? | `dir docs\docs\docs\docs\help\*.txt` |
...
```
□ Jeder Handler hat eine skills/docs/docs/docs/docs/help/*.txt Datei
...
| Fehlende Referenz | skills/docs/docs/docs/docs/help/x.txt erwähnt nicht existierende Datei | Korrigieren |
| Doppelte Doku | Info in skills/docs/docs/docs/docs/help/*.txt UND in DB | Konsolidieren |
...
|---------|------------|------------|------------|
| Lessons | skills/docs/docs/docs/docs/help/lessons.txt (statisch) | memory_lessons DB (dynamisch) | Help verweist auf DB |
...
3. **CLI-Dokumentation:** skills/docs/docs/docs/docs/help/cli.txt fehlte → **GELÖST** (erstellt)
4. **REGELWERK-INDEX:** CLI-Syntax fehlte → **GELÖST** (ergänzt)

### Erstellte Artefakte

- `skills/docs/docs/docs/docs/help/cli.txt` - CLI-Konventionen
...
```
□ skills/docs/docs/docs/docs/help/*.txt ↔ hub/handlers/*.py Abgleich
...
- `skills/docs/docs/docs/docs/help/maintain.txt` - Wartungs-Tools
- `skills/docs/docs/docs/docs/help/practices.txt` - Best Practices Index
