...
│  3. Help-Datei erstellen (skills/docs/docs/docs/docs/help/*.txt)                   │
...
**Ort:** `skills/docs/docs/docs/docs/help/<name>.txt`
...
```
□ Datei in skills/docs/docs/docs/docs/help/<name>.txt erstellt
...
□ skills/docs/docs/docs/docs/help/<name>.txt erstellt
...
- `skills/docs/docs/docs/docs/help/coding.txt` - Coding-Standards
- `skills/docs/docs/docs/docs/help/naming.txt` - Namenskonventionen
