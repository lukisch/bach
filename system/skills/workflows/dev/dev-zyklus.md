...
- Help-Dateien in skills/docs/docs/docs/docs/help/
...
```
  ...
  [ ] Help-Datei erstellt: skills/docs/docs/docs/docs/help/skills/tools/<name>.txt
```
...
- skills/docs/docs/docs/docs/help/dev.txt - Kurzreferenz Entwicklungsmodus
- skills/docs/docs/docs/docs/help/usecase.txt - Usecase-Dokumentation
