...
Letzte Aktualisierung: 2026-03-04 19:24
...
**Datei:** `skills/workflows/agent-skill-finder.md`

### Bugfix-Protokoll für Python/PyQt6 Projekte

> **Ziel:** Systematisches Vorgehen bei Bugs, um Zeit zu sparen und bekannte Probleme schnell zu erkennen.

**Datei:** `skills/workflows/bugfix-protokoll.md`

### CLI-Änderungs-Checkliste

**Version:** 1.0

**Datei:** `skills/workflows/cli-aenderung-checkliste.md`
...
**Datei:** `skills/workflows/dev-zyklus.md`

### Workflow: Dokumenten-Anforderungsanalyse

**Version:** 1.2.0

**Datei:** `skills/workflows/docs-analyse.md`

### Epstein-Methode: Wissensindexierung

**Protokoll-ID:** `epstein_wissensindexierung`

**Datei:** `skills/workflows/epstein_wissensindexierung.md`

### Gemini Delegation Workflow

> **Delegiere ressourcenintensive Tasks an Google Gemini**

**Datei:** `skills/workflows/gemini-delegation.md`

### Google Drive Delegation Workflow - SKILL v1.0

Multi-AI Kollaboration via Google Drive als Shared Workspace.

**Datei:** `skills/workflows/google-drive.md`

### Workflow: Help-Expert-Review

**Version:** 1.4.0

**Datei:** `skills/workflows/help-expert-review.md`

### Workflow: Help-Forensik

**Version:** 1.0.0

**Datei:** `skills/workflows/help-forensic.md`
...
**Datei:** `skills/workflows/migrate-rename.md`

### MCP Server Release Protokoll (NPM + GitHub)

> **Ziel:** Strukturierter Ablauf fuer das Veroeffentlichen von BACH MCP Servern auf GitHub und NPM.

**Datei:** `skills/workflows/npm-mcp-publish.md`

### Workflow: Ordner-Flattening

Ziel: Verschachtelte Ordnerstrukturen in eine flache, maschinenlesbare Struktur überführen.

**Datei:** `skills/workflows/ordner-flattening.md`
...
**Datei:** `skills/workflows/schwarm-entscheidungsbaum.md`

### Schwarm-Operationen Protokoll

**Version:** 1.0 | **Stand:** 2026-02-22 | **Bezug:** MASTERPLAN SQ051

**Datei:** `skills/workflows/schwarm-operationen.md`

### Self-Extension Workflow

> **Ziel:** BACH autonome Selbsterweiterung durch KI-Partner (Claude, Gemini, etc.)

**Datei:** `skills/workflows/self-extension.md`

### Service/Agent Validator Workflow

Qualitätsprüfung für neue Services, Agents und Experts im BACH-System.

**Datei:** `skills/workflows/service-agent-validator.md`

### Skill-Abdeckungsanalyse Workflow

**Zweck:** Systematische Analyse der BACH Skill-Abdeckung im Vergleich zu Industrie-Standards.

**Datei:** `skills/workflows/skill-abdeckungsanalyse.md`
...
**Datei:** `skills/workflows/system-anschlussanalyse.md`

### System-Aufräumen: Wartung und Archivierung

**Version:** 1.0

**Datei:** `skills/workflows/system-aufraeumen.md`

### System-Mapping: Kartographie und Feature-Erfassung

**Version:** 1.0

**Datei:** `skills/workflows/system-mapping.md`

### System-Synopse: Vergleichende Analyse

**Version:** 1.0

**Datei:** `skills/workflows/system-synopse.md`

### System-Testverfahren: B/O/E-Tests

**Version:** 1.0

**Datei:** `skills/workflows/system-testverfahren.md`

### Trampelpfadanalyse & Schwarm-Verfahren (Elephant Path / Swarm Ops)

**Version:** 2.0

**Datei:** `skills/workflows/trampelpfadanalyse.md`
...
**Datei:** `skills/workflows/wiki-author.md`
